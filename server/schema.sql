...
insert into rooms (roomname) values ('Electric Boogaloo'),('Electric Boogaloo2');

insert into users (username) values ('Kelvin'),('Kelvin2');
...
('This Works', 2, 2, STR_TO_DATE('28-10-2020 11:30:51 AM','%d-%m-%Y %h:%i:%s %p'));
